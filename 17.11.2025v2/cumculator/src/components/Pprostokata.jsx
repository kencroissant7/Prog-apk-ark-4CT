...
<>
<h1>Operacja pole prostokata</h1>
<hr />
liczba1: <input onChange={(par)=>setLiczba1(par.target.value)} placeholder = "podaj a"/><br />
liczba2: <input onChange={(par)=>setLiczba2(par.target.value)} placeholder = "podaj b"/>
<hr />
